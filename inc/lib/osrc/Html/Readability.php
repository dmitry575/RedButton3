...
// $url = 'http://lifestyle.kompasiana.com/catatan/2012/04/09/opini-mahasiswa/'; //$_GET['url'];
...
class Readability
   ...
   **/
  public $regexps = array('unlikelyCandidates'   => '/combx|comment|community|disqus|extra|foot|header|menu|remark|rss|shoutbox|sidebar|sponsor|ad-break|agegate|pagination|pager|popup|tweet|twitter/i',
  ...
  function input($html = '')
    ...
    // 	$tidy = tidy_parse_string($html, array('quot-nbsp'=>false), $charset);
    // 	$tidy->cleanRepair();
    // 	$html = $tidy->value;
    // }
  ...
  public function getContent()
    ...
    // var_dump(trim(strip_tags($this->articleContent->innerHTML)));
    // return trim(strip_tags($this->articleContent->innerHTML));
    }
  ...
  protected function initializeNode($node)
    ...
    { // unsure if strtoupper is needed, but using it just in case
      case 'DIV':
        $readability->value += 5;
        break;
      case 'PRE':
